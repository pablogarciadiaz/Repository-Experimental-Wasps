...
n.site[1]<-round(qunif(lh[,1], 2, 100))						### Number of survey sites
...
write.table(data.exp, "e:/CONTAIN/Experimental Design/Wasps/OptimalMH-Distance(AbundanceMSE-Set5).csv", sep=",")
